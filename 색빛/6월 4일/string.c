...
{
	int i, x, y;
	char word[][100] = { "They can get married. They are old enough.", "No, he won't. I only invited a few people.", 
		...
		"Five men have been killed in a car accident.", "Yes, Her chocolate chip cookies are my favorite.",  
