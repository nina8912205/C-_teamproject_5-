...
//score.c
void correct_score(int level, int score); //정답 점수 반영
void combo_bonus(int);//콤보 보너스 반영
void time_bonus(int,int);

void boss_correct_score(int , int ); //정답 점수 반영

void boss_combo_bonus(int ); //콤보 보너스 반영
