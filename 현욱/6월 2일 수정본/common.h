...
/* 점수 배열 인덱스 */
#define TOTAL 0	// 획득 점수 (보스 제외)
#define CORRECT 1	//문제 배점 점수 
#define TIME 2	//시간 보너스
#define COMBO 3 //콤보 보너스
#define BOSS 4 //획득 점수(보스)
#define B_CORRECT 5
#define B_TIME 6
#define B_COMBO 7
#define Q_CORRECT 8	//맞은 문제 수(보스 제외)
#define Q_SOLVED 9	//푼 문제 수(보스 제외)
#define B_Q_CORRECT 10	//맞은 문제 수(보스)
#define B_Q_SOLVED 11	//푼 문제 수(보스)
#define ASIZE 12
