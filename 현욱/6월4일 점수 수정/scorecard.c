...
void Final_Scorecard()
{
	...
	if (TotalScore < 70000)
		grade = 9;
	else if (70000 <= TotalScore && TotalScore < 150000)
		grade = 8;
	else if (150000 <= TotalScore && TotalScore < 180000)
		grade = 7;
	else if (180000 <= TotalScore && TotalScore < 210000)
		grade = 6;
	else if (210000 <= TotalScore && TotalScore < 240000)
		grade = 5;
	else if (240000 <= TotalScore && TotalScore < 270000)
		grade = 4;
	else if (270000 <= TotalScore && TotalScore < 300000)
		grade = 3;
	else if (300000 <= TotalScore && TotalScore < 330000)
		grade = 2;
	else
		grade = 1;
